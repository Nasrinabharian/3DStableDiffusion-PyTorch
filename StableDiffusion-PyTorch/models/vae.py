...
class VAE(nn.Module):
    def __init__(self, im_channels, model_config):
        ...
        ##################### Encoder ######################
        self.encoder_conv_in = nn.Conv3d(im_channels, self.down_channels[0], kernel_size=3, padding=(1, 1))
        ...
        self.decoder_conv_in = nn.Conv3d(self.z_channels, self.mid_channels[-1], kernel_size=3, padding=(1, 1))
